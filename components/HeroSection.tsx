    ...
    <section id="#" className="min-h-screen w-full">
      ...
      >
        ...
        <div className="relative w-full h-full flex justify-center items-center overflow-hidden">
          <div className="animate-blobanimate absolute h-[270px] w-[270px] md:h-[330px] md:w-[330px] lg:h-[450px] lg:w-[450px] 2xl:h-[500px] 2xl:w-[500px] left-[-40px] bottom-[-130px] bg-firstBlob opacity-80 blur-2xl"></div>
          <div className="animate-blobanimate absolute h-[270px] w-[270px] md:h-[330px] md:w-[330px] lg:h-[450px] lg:w-[450px] 2xl:h-[500px] 2xl:w-[500px] top-[-100px] right-[-140px] -rotate-180 bg-secondBlob opacity-80 blur-2xl"></div>
        </div>
